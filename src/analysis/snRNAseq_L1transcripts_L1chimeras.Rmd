...
write.xlsx(x = list("Apical progenitors" = dea_celltypes_fetal$`Apical progenitors`,
                    ...
                    "Microglia" = dea_celltypes_fetal$Microglia), file = "/Volumes/MyPassport/FetalCortex/manuscript/June2023/Supplemental_Table_2_gene_DEA_fetal_celltypes") # This refers to supplemental table 2
...
write.xlsx(x = list("Astrocytes" = dea_celltypes_adult$Astrocytes,
                    ...
                    "OPC" = dea_celltypes_adult$OPC), file = "/Volumes/MyPassport/FetalCortex/manuscript/June2023/Supplemental_Table_1_gene_DEA_adult_celltypes.xlsx") # Supplemental table 1
